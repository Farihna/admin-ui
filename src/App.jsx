      ...
      <div className="w-full max-w-sm">
        ...
        <div className="mt-16">
          <form action="">
            ...
            <div className="mb-6">
              <label htmlFor="password" className="block text-sm mb-2">
                <div className="flex justify-between items-end">
                  <span>Password</span>
                  <span className="text-primary text-xs cursor-pointer hover:underline">Forgot password?</span>
                </div>
              </label>
            ...
            <button
              className="h-12 rounded-sm text-sm bg-primary w-full text-white"
              type="submit"
            >
              Login
            </button>
        ...
        <div className="mb-8">
          <button
            className="h-12 flex items-center justify-center rounded-sm text-sm w-full bg-gray-05 text-gray-01"
            type="button"
          >
            <svg
              class="h-6 w-6 mr-2"
        ...
        <div className="flex justify-center">
          <a className="text-primary text-sm font-bold cursor-pointer hover:underline">Create an account</a>
        </div>
        {/* link end */}
        {/* sign in with google start */}
        <div></div>
